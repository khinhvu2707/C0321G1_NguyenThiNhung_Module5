...
public class SoTietKiemDto {
    ...
    public SoTietKiemDto(Long id, String maKhachHang, String tenKhachHang, String ngayMoSo, String ngayGui, String kiHan, String soTienGui, String laiSuat, String uuDai) {
        this.id = id;
